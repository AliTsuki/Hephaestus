...
namespace OLD
{
    public class NoiseTest : MonoBehaviour
    {
        ...
        private static readonly float STATICPerlinFrequency = 0.04f;
        private static readonly float STATICPerlinLacunarity = 2.34f;
        private static readonly int STATICPerlinOctaveCount = 4;
        private static readonly float STATICPerlinPersistance = 0.55f;
        private static readonly int STATICPerlinSeed = 0;
